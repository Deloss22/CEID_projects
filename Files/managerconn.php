					...
					<div id="main">
						<!-- login -->
							<article id="login">
								...
								<p> Κάντε login και επεξεργαστείτε τα αποθέματα του καταστήματος σας.</p>
								<form method="post" action="connectman.php">
								  <div class="fields">
								    <div class="field half">
								      <label for="username">Username</label>
								      <input type="text" name="manusername" id="manusername" required="required"></input>
								    </div>
								    <div class="field half">
								      <label for="ps">Password</label>
								      <input type="password" name="manpswd" id="manpswd" required="required"></input>
								    </div>
								  </div>
								  <ul class="actions">
